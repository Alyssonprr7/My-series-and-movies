    ...
    return (
        <div>
                ...
                <div className="h-100" style={{ background: "rgba(0,0,0,0.7)" }}>
                    <div className="h-100 container">
                        <div className="row h-100 align-items-center">
                            <div className="col-3">
                                <img src={data.poster} alt={data.name} className="img-fluid img-thumbnail"></img>
                            </div>
                            <div className="col8">
...

            {
                ...
                <div className="container">
                    <h1>Editar Série</h1>
                    <button onClick={() => { setMode("INFO") }}>Cancelar Edição</button>
                    <form>
                        ...
                        <div className="form-group">
                            ...
                            <input type="text" value={form.comments} className="form-control" onChange={onChange("comments")} id="name" placeholder="Comentários" />
                        </div>
                        <div className="form-group">
